...
provider('appConfig', function(){
	...
	'serverPath': "http://localhost:3005/",
	'publicPath': "http://localhost:3005/",		//this will be OVERWRITTEN later by the vanity port, IF set
	'homeDirectory': false,
		...
		*/
		...
		this.cfgJson ={
			...
			"server":{
				"domain":"localhost",
				"_domain":"127.0.0.1",
				"_domainComment":"Must use ip address for twitter (login, e2e testing)",
				"scheme":"http",
				"port":3005,
			...
			"twitter":{
				...
				"callback_url":"http://127.0.0.1:3005/callback-twitter-auth",
				"handle":""
			},
			"google":{
				...
				"callback_url":"http://localhost:3005/callback-google-auth"
			},
			"sauceLabs":{
				"user":"",
				"key":""
