/**
Tests for all /api/e2eMocks endpoints
...
@param {Object} params
*/
E2eMocks.prototype.run =function(params) {
	var deferred =Q.defer();
	
	describe('E2eMocksModule', function() {
		it("should test all e2eMocks calls", function(done)
		{
			var promise =before({});
...
function go(params) {
	...
	*/
	var todo =function(opts) {
		...
		api.expectRequest({method:'E2eMocks.todo'}, {data:params}, {}, {})
		.then(function(res) {
