/**
Tests for all /api/google endpoints
...
@param {Object} params
*/
Google.prototype.run =function(params) {
	var deferred =Q.defer();
	
	describe('GoogleModule', function() {
		it("should test all google calls", function(done)
		{
			var promise =before({});
...
function go(params) {
	...
	*/
	var todo =function(opts) {
		...
		api.expectRequest({method:'Google.todo'}, {data:params}, {}, {})
		.then(function(res) {
