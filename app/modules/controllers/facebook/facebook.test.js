/**
Tests for all /api/facebook endpoints
...
@param {Object} params
*/
Facebook.prototype.run =function(params) {
	var deferred =Q.defer();
	
	describe('FacebookModule', function() {
		it("should test all facebook calls", function(done)
		{
			var promise =before({});
...
function go(params) {
	...
	*/
	var todo =function(opts) {
		...
		api.expectRequest({method:'Facebook.todo'}, {data:params}, {}, {})
		.then(function(res) {
